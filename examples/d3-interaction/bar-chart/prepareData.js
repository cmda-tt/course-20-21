...
function transformData(source){
  let transformed =  d3.rollup(source, calcStatsForGroup,d => d.preference)

  let transformedArray = []
  for (let [key, value] of transformed){
		 transformedArray.push({ key: key, value: value })
  }
